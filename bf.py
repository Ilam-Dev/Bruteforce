...
def banner():
    time.sleep(1.5)
    os.system("clear")
    print "{}   ___ ___                {}__ ".format(b,m)
    print "{}  /   |   \{}_____   {} ____ {}|  | __ {}_____{}______ ".format(b,m,b,m,b,m)
    print "{} /    ~    \{}__  \ {}_/ ___\{}|  |/ /{}/ __ \{}_  __ \ ".format(b,m,b,m,b,m)
    print "{} \    Y    /{}/ __ \{}\  \___{}|    <{}\  ___/{}|  | \/ ".format(b,m,b,m,b,m)
    print "{}  \___|_  /{}(____  /{}\___  >{}__|_ \{}\___  >{}__|        {}V 1.0  ".format(b,m,b,m,b,m,n)
    print "{}        \/   {}   \/   {}  \/ {}    \/ {}   \/      {}By: {}Tn. Sad Boy{}".format(b,m,b,m,b,n,c,n)

banner()
print ""
print "       {}[  {}https://{}www.github.com/Ilam-Dev  {}]".format(b,m,h,b)
print ""
print "{}[ {}ID {}/ {}NOMOR Tlpon {}/ {}Username {}] ".format(c,n,c,n,c,n,c)
email_target = str(raw_input(h+" =•>\033[1;36m "))
print " "
print "{}[    {}Masukkan {}Wordlist    {}]".format(c,b,m,c)
password_list = str(raw_input(h+" =•>\033[1;36m "))
